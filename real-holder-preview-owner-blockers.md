...
| `OWNER-RHP-05` | Pilot issuer and verifier relationships | End-to-end pilot | OPEN |
| `OWNER-RHP-06` | Supported-browser and device policy | Release candidate | OPEN |
...
| `OWNER-RHP-12` | Production hosting, repository, and deployment controls | Real-data deployment | OPEN |
| `OWNER-RHP-13` | Incident response and vulnerability-disclosure ownership | Pilot operations | OPEN |
| `OWNER-RHP-14` | BVS inclusion and provider agreements | Any BVS-backed pilot | OPEN |
| `OWNER-RHP-15` | Public conformance language and standards coordination | Public communications | OPEN |
...
**Acceptable evidence:** A signed or otherwise authenticated publication record, immutable hosted bytes, matching repository pins, reproducible hashes, and an owner-approved resource manifest.
...
**Acceptable evidence:** Screenshots or exported policy, successful protected-environment dry run, rollback rehearsal, and public-origin header verification.
...
1. Security contact and backup contact.
